...
#		$ python postHitSandbox.py ../experiments/jdf/single_identity_empathy_v4/turkHitParams.py
#
# 3. to post to "actual" MTURK, open the terminal and run these commands
# 		$ cd /Volumes/turk/boto
#		$ python postHitActual.py ../experiments/jdf/single_identity_empathy_v4/turkHitParams.py
...
projectNameForRequesters = "jdf-singleIdentity-e4-empathy-v3"
...
pay = 0.50	
numAssignmentsToPost = 100 # turk calls this "Number of assignments per HIT"
...
# Design Layout
urlForHIT = "https://scorsese.wjh.harvard.edu/turk/experiments/jdf/single_identity_empathy_v4/landingPage.html"
frameHeight = 675
