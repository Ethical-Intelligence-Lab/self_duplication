...
dir <- setwd("/Users/julian/Dropbox (Personal)/Research/Intuition/single_identity/e3_resurrection/data")
...
p1+scale_x_discrete(breaks = 1:length(condNames), labels=condNames)+
  ...
  xlab("State of the Original")+ylab("Proportion")+
