...
#neither
length(identity_b_neither[identity_b_neither==1 & living=='alive'])/length(identity_b_neither[living=='alive'])
length(identity_b_neither[identity_b_neither==1 & living=='dead'])/length(identity_b_neither[living=='dead'])
length(identity_b_neither[identity_b_neither==1 & persp=='first'])/length(identity_b_neither[persp=='first'])
length(identity_b_neither[identity_b_neither==1 & persp=='third'])/length(identity_b_neither[persp=='third'])

#both
length(identity_b_both[identity_b_both==1 & living=='alive'])/length(identity_b_both[living=='alive'])
length(identity_b_both[identity_b_both==1 & living=='dead'])/length(identity_b_both[living=='dead'])
