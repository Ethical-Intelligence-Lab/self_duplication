...
#		$ python postHitSandbox.py ../experiments/jdf/moralCapture_e10_conflictingInfo/turkHitParams.py
#
# 3. to post to "actual" MTURK, open the terminal and run these commands
# 		$ cd /Volumes/turk/boto
#		$ python postHitActual.py ../experiments/jdf/moralCapture_e10_conflictingInfo/turkHitParams.py

# alvarezlab, konklab
lab = "defreitas"
# Describe your Hit to Workers
titleForWorkers = "Duplication Judgment"
descriptionForWorkers = "Watch a short movie and answer quick questions! Takes 5 min. Please only participate if you have normal or corrected-to-normal vision, and if you haven't done Duplication Judgment before"
keywordsForWorkers = ["short","fun","easy"]

# title for you (workers don't see this, but you will in the "manage hits" interface)
projectNameForRequesters = "jdf-singleIdentity-e2-particles"
...
pay = 0.50	
numAssignmentsToPost = 1 # turk calls this "Number of assignments per HIT"
...
# Design Layout
urlForHIT = "https://scorsese.wjh.harvard.edu/turk/experiments/jdf/singleIdentity_e2_particles/landingPage.html"
frameHeight = 675
